...
export const CapturePreferencesContainer = ({
    setPage,
    sendDataToServer,
        ...
        <CapturePreferecesContainerStyle>
            ...
            >
                ...
                <form onSubmit={sendDataToServer}>
                    ...
                    <TextInput placeholder="Specialisation" onChange={handleSpecialisationChange} />
                    {' '}
                    <br />
                    <h3>What kind of project would you like to create?</h3>
                    <PreferenceLabel htmlFor="domainName">Domain</PreferenceLabel>
                    <TextInput placeholder="Domain Name (eg. Rehab)" onChange={handleDomainChange} required />
                    {' '}
                    <br />
                    <PreferenceLabel htmlFor="themeName">Theme</PreferenceLabel>
                    <TextInput placeholder="Theme Name (eg. Speech)" onChange={handleThemeChange} required />
                    {' '}
                    <br />
                    <PreferenceLabel htmlFor="keyword">Keyword</PreferenceLabel>
                    <TextInput placeholder="Keyword" onChange={handleKeywordChange} required />
                    {' '}
                    <br />
                    <br />
                ...
                {' '}
                <br />
                <Button marginRight={16} appearance='primary' onClick={() => setPage('welcome')}>
                    Back
                </Button>
            </div>
        </CapturePreferecesContainerStyle>
