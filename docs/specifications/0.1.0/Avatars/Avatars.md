...
- When the Unity project is created all downloaded avatars are exported to `Assets/Avatars` (currently `Assets/Avatars/uuid.zip`, I would like this to be `Assets/Avatars/uuid.fbx`)
...
- `token` is the TUD server ID. This is also the file name, e.g. `Assets/Avatars/7972979e-4710-11ee-82ac-d6007ec8b6a7.zip`
