...
Write-Host ""
Write-Host "Installing unity version 2021.3.45f2 through Unity Hub ... " -ForegroundColor Cyan
...
"-- --headless install --version 2021.3.45f2 --changeset 88f88f591b2e" -Wait
...
Write-Host "If the installation process appears to be stuck, try pressing Enter after waiting for a while." -ForegroundColor Cyan
Start-Process -FilePath "$unityHubPath" -ArgumentList `
"-- --headless install-modules --version 2021.3.45f2 --module android android-sdk-ndk-tools android-open-jdk-8u172-b11" -Wait
