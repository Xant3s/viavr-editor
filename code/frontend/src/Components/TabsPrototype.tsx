...
export const TabsPrototype = () => {
    ...
    const getComponent = (id: number) => {
        switch(id) {
            case 0: return <TestComponent title={'Test Component 1'} />
            case 1: return <TestComponent title={'Test Component 2'} />
            case 2: return <TestComponent title={'Test Component 3'} />
            case 3: return <TestComponent title={'Test Component 4'} />
        }
    }
