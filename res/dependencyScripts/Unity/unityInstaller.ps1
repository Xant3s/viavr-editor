...
if (-not (Test-Path $unityInstaller)) {
    Start-BitsTransfer -Source $unityInstallerUrl -Destination $unityInstaller -UseBasicParsing
...
if (-not (Test-Path $unityAndriodInstaller)) {
    Start-BitsTransfer -Source $unityAndriodInstallerUrl -Destination $unityAndriodInstaller -UseBasicParsing
